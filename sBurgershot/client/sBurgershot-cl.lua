...
mainMenu = NativeUI.CreateMenu('', '~g~À la carte :', 0, 0, 'commonmenu', 'interaction_bgd', 0, 255, 255, 255, 255)
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(sBurgershot) do
            ...
            if dist <= 1.2 then
                ESX.ShowHelpNotification("Appuyez sur ~INPUT_TALK~ pour parlez avec le ~g~Vendeur")
